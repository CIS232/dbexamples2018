 ...
 */
public class CreateCoffeeDBMySql
{
	public static void main(String[] args)
	{
		// Create a named constant for the URL.
		// NOTE: This value is specific for Mysql. The default port is 3306, but I ran it on 33306
		final String DB_URL = "jdbc:mysql://localhost:33306/coffee";
